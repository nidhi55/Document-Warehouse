					...
					<div class="row">
						<div class="col-md-3">
							<div class="fh5co-navbar-brand">
								<div class='dropdown'>
									...
									$a=$row[2];
									$path=$row[8];
									echo "<img src='$path' height='80px' width='80px' style='border-radius: 50%;'></button>
								  <div class='dropdown-content'>
								    <a href='theme.php' style='font-size: 15px;'>Theme</a>
								    <a href='setting.php' style='font-size: 15px;'>Setting</a>
								    <a href='logout.php' style='font-size: 15px;'>Logout</a>
								  </div>";
								  echo "&nbsp<b style='font-size:20px; ' >".$a."</b>";
								}
								?>
								</div>
						...
						<div class="col-md-9">
							<ul class="nav text-center">
								...
								<li><a href="services3.php">Friend List</a></li>
							</ul>
						</div>
		...
		<section id="services">
			<div class="container">
				<div class="row"><center>
					...
					<?php
						include 'conn.php';
						$query=mysqli_query($conn,"select *from friend where receive='$a'");
						$n=mysqli_num_rows($query);
						for($i=0;$i<$n;$i++)
						{
							$row=mysqli_fetch_row($query);
							echo "<tr><td>$row[1]
									<tr><td><button type=submit>Delete</button><td><button type=submit>Accept</button><HR>	";
						}
					?>
						    </table></center>
