		...
		<section id="services">
			<div class="container">
				<div class="row"><center>
					...
					<form action='setting_data.php' method='POST' enctype='multipart/form-data'>

					<input type='text' name='name' required/><input type='file' name='file'>
					<input type='submit' name='submit87'>
					</form>
