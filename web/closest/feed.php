							...
							<div class="col-md-6 col-md-offset-3 subtext">
								<div class="container1">
									<form action="feedaction.php" method="POST">
									    ...
									    <input type="text" id="fname" name="uname" disabled placeholder="Your UserName.." value=<?php echo $a; ?>>
									    <label for="lname">Email</label>
									    <input type="email" id="lname" name="mail" placeholder="Your Email.." value=<?php echo $b; ?>>
