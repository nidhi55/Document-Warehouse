		...
		<section id="services">
			<div class="container">
				<div class="row"><center><b>
				    ...
				    <tr>
				    <th colspan="4">your uploads...<label><a href="frnew.php">View Shared File</a></label></th>
				    </tr>
				    <tr>
				    <td>File Name</td>
						 ...
						 for ($i=0; $i < $n; $i++) { 
						 	...
						 	?>
						        ...
						        <td><?php echo $row[2];
						        	 $b=$row[2]; ?></td>
						        <td><?php echo $row[3]; 
						        	$c=$row[3]; $path=$row[4]; ?></td>
						        <td><?php echo "<td><a href='frlist.php?share=$path&a=$a&b=$b&c=$c'><img src='image/shar.jpg' height='40' width='100'></img></a></td>"; ?></td>
