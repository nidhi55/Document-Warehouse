...
<nav class="navbar navbar-expand-md navbar-dark fixed-top">
      ...
      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
		...
		$res=mysqli_query($conn,"select * from a0$id");
		$n=mysqli_num_rows($res);
			...
			<div class='container'>
				<div class='row'>
					<div class='col-md-4'>
						...
						<embed src='$b' height='450px' width='400px'></embed>
							<a class='image-popup text-center' href='#' style='height:400px; width=400px;'>
