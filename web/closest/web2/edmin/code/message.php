            ...
            <div class="navbar-inner">
                <div class="container">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                        <i class="icon-reorder shaded"></i></a><a class="brand" href="index1.php">Edmin </a>
                    ...
                    <div class="span3">
                        <div class="sidebar">
                            ...
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="charts.php"><i class="menu-icon icon-bar-chart"></i>Uploaded File</a></li>
                                <li><a href="charts.php"><i class="menu-icon icon-bar-chart"></i>Delete account</a></li></ul>
                            <!--/.widget-nav-->
                            <ul class="widget widget-menu unstyled">
