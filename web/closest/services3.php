				...
				<div class="row"><center>
					...
					<?php
						...
						for($i=0;$i<$n;$i++)
						{
							...
							echo "<tr><td>$row[1]</td>
									<td><a href='accept.php?send=$row[1]&rec=$a'><img src='image/accept.jpg' height='40' width='100'></a></td><td><a href='fdelete.php?send=$row[1]&rec=$a'><img src='image/delete.jpg' height='40' width='100'></a></td></tr>";
						}
					?>
						    </table></b></center>
